...
//			// String basePath =
//			// "/Users/jaydeep/jaydeep_workstation/ASU/Research/oaei/2018/KnowledgeGraphs/LargeBio_dataset_oaei2019/local_Gen/task_1_FMA_NCI_small/";
//			// String srcFlPath = basePath +
//			// "s_oaei_FMA_small_overlapping_nci.owl";
//			// String trgtFlPath = basePath +
//			// "t_oaei_NCI_small_overlapping_fma.owl";
//
//			// LargeBio-task-2
//			// String dbNm = "LargeBio-track2";
//			// String basePath =
//			// "/Users/jaydeep/jaydeep_workstation/ASU/Research/oaei/2018/KnowledgeGraphs/LargeBio_dataset_oaei2019/local_Gen/task_2_FMA_NCI_whole/";
...
//			// String basePath =
//			// "/Users/jaydeep/jaydeep_workstation/ASU/Research/oaei/2018/KnowledgeGraphs/LargeBio_dataset_oaei2019/local_Gen/task_3_FMA_SNOMED_small/";
//			// String srcFlPath = basePath +
//			// "s_oaei_FMA_small_overlapping_snomed.owl";
//			// String trgtFlPath = basePath +
//			// "t_oaei_SNOMED_small_overlapping_fma.owl";
//
//			// LargeBio-task-4
//			// String dbNm = "LargeBio-track4";
//			// String basePath =
//			// "/Users/jaydeep/jaydeep_workstation/ASU/Research/oaei/2018/KnowledgeGraphs/LargeBio_dataset_oaei2019/local_Gen/task_4_FMA_SNOMED_whole/";
//			// String srcFlPath = basePath + "s_oaei_FMA_whole_ontology.owl";
//			// String trgtFlPath = basePath +
//			// "t_oaei_SNOMED_extended_overlapping_fma_nci.owl";
//
//			// LargeBio-task-5
//			// String dbNm = "LargeBio-track5";
//			// String basePath =
//			// "/Users/jaydeep/jaydeep_workstation/ASU/Research/oaei/2018/KnowledgeGraphs/LargeBio_dataset_oaei2019/local_Gen/task_5_SNOMED_NCI_small/";
//			// String srcFlPath = basePath +
//			// "s_oaei_SNOMED_small_overlapping_nci.owl";
//			// String trgtFlPath = basePath +
//			// "t_oaei_NCI_small_overlapping_snomed.owl";
//
//			// LargeBio-task-6
//			// String dbNm = "LargeBio-track6";
//			// String basePath =
//			// "/Users/jaydeep/jaydeep_workstation/ASU/Research/oaei/2018/KnowledgeGraphs/LargeBio_dataset_oaei2019/local_Gen/task_6_SNOMED_NCI_whole/";
//			// String srcFlPath = basePath +
//			// "s_oaei_SNOMED_extended_overlapping_fma_nci.owl";
//			// String trgtFlPath = basePath + "t_oaei_NCI_whole_ontology.owl";
//
//			// Anatomy
//			String dbNm = "Anatomy";
...
//					.decodeBase64(ontoServiceModel.getSrc_in_data().getFile());
//			FileUtils.writeByteArrayToFile(srcfile, srcbytes);
//
//			File trgtfile = new File(opPath + "target.json");
//			byte[] trgtbytes = org.apache.commons.codec.binary.Base64
//					.decodeBase64(ontoServiceModel.getTrgt_in_data().getFile());
...
//			String srcFlPath = basePath + "human.owl";
//			String trgtFlPath = basePath + "mouse.owl";
//			String opFl = System.getProperty("user.dir") + File.separator + "ontofiles" + File.separator + "op.rdf";
//
//			File srcFile = new File(srcFlPath);
//			File trgtFile = new File(trgtFlPath);
//
//			OntoConnController ontoConnController = new OntoConnController();
//			ontoConnController.ontoConnController(dbNm, srcFile, trgtFile, opFl);
//			
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
